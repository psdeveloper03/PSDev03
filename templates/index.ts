...
import { generate as generate_listmonk } from "./listmonk";
import { meta as meta_listmonk } from "./listmonk/meta";
...
const templates = [
  ...
  { slug: "budibase", meta: meta_budibase, generate: generate_budibase },
  {
    ...
    meta: meta_changedetection,
    generate: generate_changedetection,
  },
  ...
  {
    slug: "drone-runner",
    meta: meta_drone_runner,
    generate: generate_drone_runner,
  },
  ...
  {
    slug: "filebrowser",
    meta: meta_filebrowser,
    generate: generate_filebrowser,
  },
  ...
  {
    slug: "homeassistant",
    meta: meta_homeassistant,
    generate: generate_homeassistant,
  },
  ...
  { slug: "listmonk", meta: meta_listmonk, generate: generate_listmonk },
  {
    slug: "libreoffice",
    meta: meta_libreoffice,
    generate: generate_libreoffice,
  },
  {
    slug: "libretranslate",
    meta: meta_libretranslate,
    generate: generate_libretranslate,
  },
  ...
  {
    slug: "meilisearch",
    meta: meta_meilisearch,
    generate: generate_meilisearch,
  },
  ...
  {
    slug: "mysql-backup",
    meta: meta_mysql_backup,
    generate: generate_mysql_backup,
  },
  ...
  {
    slug: "openspeedtest",
    meta: meta_openspeedtest,
    generate: generate_openspeedtest,
  },
  {
    slug: "paperlessngx",
    meta: meta_paperlessngx,
    generate: generate_paperlessngx,
  },
  ...
  {
    slug: "ploi-roadmap",
    meta: meta_ploi_roadmap,
    generate: generate_ploi_roadmap,
  },
  ...
  { slug: "portainer", meta: meta_portainer, generate: generate_portainer },
  {
    ...
    meta: meta_postgres_backup,
    generate: generate_postgres_backup,
  },
  {
    slug: "powerdns-admin",
    meta: meta_powerdns_admin,
    generate: generate_powerdns_admin,
  },
  { slug: "prowlarr", meta: meta_prowlarr, generate: generate_prowlarr },
  {
    slug: "psitransfer",
    meta: meta_psitransfer,
    generate: generate_psitransfer,
  },
  ...
  {
    slug: "simpletorrent",
    meta: meta_simpletorrent,
    generate: generate_simpletorrent,
  },
  ...
  {
    slug: "statping-ng",
    meta: meta_statping_ng,
    generate: generate_statping_ng,
  },
  ...
  {
    slug: "vaultwarden",
    meta: meta_vaultwarden,
    generate: generate_vaultwarden,
  },
  { slug: "verdaccio", meta: meta_verdaccio, generate: generate_verdaccio },
  {
    slug: "vscode-server",
    meta: meta_vscode_server,
    generate: generate_vscode_server,
  },
